...
web_CCWARN:=-Wno-comment -Wno-parentheses -Wno-incompatible-library-redeclaration -Wno-builtin-requires-header
web_MAIN_CC:=clang -c -MMD -O3 --target=wasm32 -nostdlib -Werror -Isrc $(web_CCWARN) $(call OPTDEF,web_MAIN)
web_AUDIO_CC:=clang -c -MMD -O3 --target=wasm32 -nostdlib -Werror -Isrc $(web_CCWARN) $(call OPTDEF,web_AUDIO)
...
generic_OPT_ENABLE:=genioc io fs a_dummy v_dummy i_dummy r1b synmin native gcfg inmgr
...
linux_OPT_ENABLE:=genioc io fs a_pulse v_xegl i_evdev xinerama r1b synmin native gcfg inmgr
...
linuxdrm_OPT_ENABLE:=genioc io a_pulse v_drmgx i_evdev r1b synmin fs native gcfg inmgr
...
macos_OPT_ENABLE:=macos io fs r1b synmin native gcfg inmgr
...
mswin_OPT_ENABLE:=mswin genioc io fs r1b synmin native gcfg inmgr
